...
export async function WithdrawalHistory(userID: number) {
  try {
    const response = await fetch(
      "https://cap-partners-investment.cyclic.app/api/v0/investors/withdraw_history",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export async function AddToNewsLetter(email: string) {
  try {
    const response = await fetch(
      "https://cap-partners-investment.cyclic.app/api/v0/admin/adminapis/subsribe_to_newsletter",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",

...
export const TermsText = [
  {
    ...
    subtitle:
      "In the event of death of an investor, the next of kin shall notify the Company with the death certificate issued by a credible and certified hospital, as well as the grant of Probate or Letters of administration in favour of the next of kin or other beneficiaries.",
  },
  {
    id: 2,
    title: "Accuracy of Information:",
    subtitle:
      "Occasionally there may be information on the website that contains typographical errors, inaccuracies or omissions that may relate to availability, promotions and offers. We reserve the right to correct any errors, inaccuracies or omissions, and to change or update information if any information on the website or any related service is inaccurate at any time without prior notice. We undertake no obligation to update, amend or clarify information on the Website including, without limitation, pricing information, except as required by law.<br/><br/> Uptime guarantee <br/><br/> We offer a Service uptime guarantee of 99% of available time per month. The service uptime guarantee does not apply to service interruptions caused by: (1) periodic scheduled maintenance or repairs we may undertake from time to time; (2) interruptions caused by you or your activities; (3) outages that do not affect core Service functionality; (4) causes beyond our control or that are not reasonably foreseeable; and (5) outages related to the reliability of certain programming environments.",
  },
  {
    id: 3,
    title: "Backups",
  ...
  },
  {
    ...
    title: "SUBMISSIONS",
    subtitle:
      "You acknowledge and agree that any questions, comments, ideas, suggestions, feedback or other information regarding the site(“submissions”) provided by you to us are non-confidential and shall become our sole property. We shall own exclusive rights, including all intellectual property rights, and shall be entitled to the unrestricted use and dissemination of these submissions for any lawful purpose, commercial or otherwise, without acknowledgement or compensation to you. You hereby waive all moral rights to any such submissions, and you hereby warrant that any such submissions are original with you or that you have such right to submit such submissions. <br/><br/> You agree there shall be no recourse against us for any alleged or actual infringement or misappropriation of any proprietary right in your submission.",
  },
];

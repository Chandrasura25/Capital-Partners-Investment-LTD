      ...
      <section className="paddings relative z-10" id="pillars">
        ...
        >
          ...
          <motion.div variants={fadeIn("up", "tween", 0.2, 1)}>
            <p className="relative font-normal text-center md:px-[100px] px-[20px] text-white">
            ...
            <p className="relative font-normal text-center md:px-[100px] px-[20px] text-white">
              ...
              social responsibility. We invite you to explore the possibilities
              of partnering with Capital Partners Investment LTD, where your
              financial goals meet our strategic vision, creating a path to
              mutual success.
            </p>
          </motion.div>
        </motion.div>
